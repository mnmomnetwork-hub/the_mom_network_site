  ...
  return (
    <div className="container mx-auto py-12 px-4 max-w-2xl">
      <div className="text-center mb-10">
        <h1 className="text-4xl font-bold tracking-tight sm:text-5xl mb-4">Submit Your Story</h1>
        <p className="text-lg text-navy/80 max-w-2xl mx-auto">
          Share your story with The Mom Network community. Whether you need support or want to inspire others, your
          voice matters here.
        </p>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Tell us about your journey as a mom. Your story could help and inspire other mothers in our community.
          </CardDescription>
        </CardHeader>
